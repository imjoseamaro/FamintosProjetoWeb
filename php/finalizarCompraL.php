...
foreach ($_SESSION['carrinho'] as $cd => $qnt)  {
	...
	$inserir = $cn->query("INSERT INTO tbl_venda(no_Ticket,cd_cliente,cd_comida,qt_comida,vl_item,dt_venda,opcao)  VALUES
	('$ticket','$cd_user','$cd','$qnt','$preco','$data','Levar para viagem')");
